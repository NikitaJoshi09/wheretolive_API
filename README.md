WhereToLive
A FastAPI + PostgreSQL backend that helps users compare Indian cities on livability — cost of living, air quality, safety, and healthcare — with AI-generated summaries and recommendations powered by Gemini.
...
Tables are created automatically on startup. Visit http://127.0.0.1:8000/docs for interactive API docs.
...
Deployment
Deployed on Render — see DEPLOYMENT.md for step-by-step instructions covering PostgreSQL setup, environment variables, and the web service configuration.
